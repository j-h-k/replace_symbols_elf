...
def create_dmtcp_h_file():
    ...
    headers = ('#ifndef __DMTCP_H_\n'
               ...
               'EXTERNC void * dmtcp_dlsym(char *, void *, int, long int *);\n')

    nextfnc = ('#define NEXT_FNC_DEFAULT(func)\\\n'
               '({\\\n'
               'static __typeof__(&func) _real_ ## func = (__typeof__(&func)) -1;\\\n'
               'if (_real_ ## func == (__typeof__(&func)) -1) {\\\n'
               '  _real_ ## func = (__typeof__(&func)) dmtcp_dlsym( # func, (void *)&func, plugin_id, func ## addrs);\\\n'
               '}\\\n'
               '_real_ ## func;\\\n'
               '})\n')
...
def append_dmtcp_plt(symbolToFind, returntype, argumenttypes, firstcallargs):
    ...
    if returntype != 'void':
        fo.write('return ')
    fo.write('NEXT_FNC_DEFAULT('+symbolToFind+')('+firstcallargs+');\n')
    closecurl(fo) 
