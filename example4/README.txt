**************************************************
  THIS IS ALL DONE IN THE MAKEFILE, besides STEP (1)
...
Step (3)
	Run:
		$> python elf.py -cfile <symbolname> <return type> <argument type with vars> <argument vars>

	This will generate the <symbolname>__DMTCP.c that will perform the PLT functionality + dlsym functionality
...
Step (5)
	...
	that mimics the PLT functionaly + dlsym functionality
