...
def create_dmtcp_h_file():
    ...
    nextfnc = ('#define NEXT_FNC(func)\\\n'
               ...
               '  _real_ ## func = (__typeof__(&func)) func ## __dmtcp_dlsym( # func, &func);\\\n'
               '}\\\n'
               '_real_ ## func;\\\n'
               '})\n')
...
def create_dmtcp_c_file(symbolToFind, returntype, argumenttypes, firstcallargs):
    ...
    # dmtcp_dlsym
    dmtcp_dlsym = 'void * {}__dmtcp_dlsym(char *str, void *fptr)'.format(symbolToFind)
  ...
  return (void *) addrs[0];
    ...
    # <symbol>__dmtcp_plt
    dmtcp_plt = '{0} {2}__dmtcp_plt({1})'.format(returntype, argumenttypes, symbolToFind)
    fo.write(dmtcp_plt)
...
if __name__ == '__main__':
    if sys.argv[1] == '-cfile' and len(sys.argv) == 6:
        create_dmtcp_h_file()
